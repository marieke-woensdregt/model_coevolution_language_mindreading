...
context_generation = 'random'  # This can be set to either 'random', 'only_helpful' or 'optimal'
if n_meanings == 2:
...
if __name__ == "__main__":
    ...
    # Below the actual writing of the results to text and pickle files happens:
        ...
        pickle_file_title_all_results = directory+'/Results_'+file_title

        saveresults.write_results_to_pickle_file(pickle_file_title_all_results, all_results_dict)


        pickle_file_title_mean_std_final_posteriors = directory+'/Mean_Std_Final_Post_'+file_title
