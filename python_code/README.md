...
**(This is just a copy of what's in the README.md file in the folder [model_coevolution_language_mindreading](https://github.com/marieke-woensdregt/model_coevolution_language_mindreading/tree/master))**
