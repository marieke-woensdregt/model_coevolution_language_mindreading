...
def get_final_pop_lex_indices(directory, copy_specification, n_runs, n_iterations, pop_size, pragmatic_level, optimality_alpha, communication_type, ca_measure_type):
...
if __name__ == "__main__":
    ...
    final_pop_lex_indices = get_final_pop_lex_indices(iteration_results_directory, '_c'+str(run_number+1), n_runs_initial_pop, n_iterations_initial_pop, pop_size_initial_pop, pragmatic_level_initial_pop, optimality_alpha_initial_pop, communication_type_initial_pop, ca_measure_type_initial_pop)
    ...
    if context_generation == 'random':
        if selection_type == 'none' or selection_type == 'l_learning':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)
        elif selection_type == 'p_taking':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)
        elif selection_type == 'ca_with_parent':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_init_'+communication_type_initial_pop+'_'+ca_measure_type_initial_pop+'_mutants_'+communication_type_mutants+'_'+ca_measure_type_mutants+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)


    elif context_generation == 'only_helpful' or context_generation == 'optimal':
        if selection_type == 'none' or selection_type == 'l_learning':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(len(helpful_contexts))+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)
        elif selection_type == 'p_taking':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(len(helpful_contexts))+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)
        elif selection_type == 'ca_with_parent':
            filename = 'evo_anal_'+str(n_meanings)+'M_'+str(n_signals)+'S'+'_size_'+str(pop_size_mixed_pop)+'_select_'+selection_type+'_init_'+communication_type_initial_pop+'_'+ca_measure_type_initial_pop+'_mutants_'+communication_type_mutants+'_'+ca_measure_type_mutants+'_'+str(n_iterations_mixed_pop)+'_I_'+str(n_contexts)+'_C_'+str(context_generation)+'_'+str(len(helpful_contexts))+'_'+str(n_utterances)+'_U_'+'err_'+error_string+'_init_pop_'+pragmatic_level_initial_pop+'_a_'+str(optimality_alpha_initial_pop)[0]+'_mutants_'+pragmatic_level_mutants+'_a_'+str(optimality_alpha_mutants)[0]+'_sp_hyp_'+pragmatic_level_parent_hyp+'_p_prior_'+str(perspective_prior_type)[0:4]+'_'+perspective_prior_strength_string+'_l_prior_'+str(lexicon_prior_type)[0:4]+'_'+lexicon_prior_constant_string+'_dcpl_'+str(decoupling)+'_r'+str(run_number)
    ...
    pickle_file_title_max_offspring_single_parent = results_directory+'Max_Offspring_'+filename
